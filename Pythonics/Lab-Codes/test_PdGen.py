...
for train_seed, test_seed in zip(range(0,1000),range(2000,3000)):
    startcycle = time.time()
    ## Recessive Main Effect for SNP1 without interaction 
    # Training data
    train_rec_main_effect465 = sim.BAMS.from_model(eff1=sim.SNPEffectEncodings.RECESSIVE, eff2=sim.SNPEffectEncodings.ADDITIVE, penetrance_base=0.465, main1=1, main2=0, interaction=0, snp1=variant1, snp2=variant2, random_seed=train_seed)
