...
for train_seed, test_seed in zip(range(0, 1), range(2000, 2001)):
    ...
    test_rec_me_pb000_DOMDEV["SNP1"] = test_rec_me_pb000_DOMDEV["SNP1"].replace(2, 0)
    test_rec_me_pb000_DOMDEV["SNP2"] = test_rec_me_pb000_DOMDEV["SNP2"].replace(2, 0)
    ...
    DOMDEV_results_rec_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    DOMDEV_results_rec_me_pb000.insert(loc=0, column="TestSeed", value=test_seed)
    ...
    rec_results_rec_me_pb000["odds ratio"] = np.exp(rec_results_rec_me_pb000["Beta"])
    rec_results_rec_me_pb000.insert(loc=0, column="Encoding", value="Recessive")
    rec_results_rec_me_pb000.insert(loc=0, column="BioAct", value="Recessive")
    rec_results_rec_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    ...
    dom_results_rec_me_pb000["odds ratio"] = np.exp(dom_results_rec_me_pb000["Beta"])
    ...
    dom_results_rec_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    ...
    codom_results_rec_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    codom_results_rec_me_pb000.insert(loc=0, column="TestSeed", value=test_seed)
    ...
    edge_results_rec_me_pb000["odds ratio"] = np.exp(edge_results_rec_me_pb000["Beta"])
    ...
    edge_results_rec_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    ...
    add_results_sub_add_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    add_results_sub_add_me_pb000.insert(loc=0, column="TestSeed", value=test_seed)
    ...
    DOMDEV_results_sub_add_me_pb000 = pd.concat(
        [DOMDEV_results_sub_add_me_pb000_SNP1, DOMDEV_results_sub_add_me_pb000_SNP2]
    )
    ...
    DOMDEV_results_sub_add_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    DOMDEV_results_sub_add_me_pb000.insert(loc=0, column="TestSeed", value=test_seed)
    ...
    rec_results_sub_add_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    rec_results_sub_add_me_pb000.insert(loc=0, column="TestSeed", value=test_seed)
    ...
    dom_results_sub_add_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    dom_results_sub_add_me_pb000.insert(loc=0, column="TestSeed", value=test_seed)
    ...
    codom_results_sub_add_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    codom_results_sub_add_me_pb000.insert(loc=0, column="TestSeed", value=test_seed)
    ...
    edge_results_sub_add_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    edge_results_sub_add_me_pb000.insert(loc=0, column="TestSeed", value=test_seed)
    ...
    add_results_add_me_pb000["odds ratio"] = np.exp(add_results_add_me_pb000["Beta"])
    ...
    add_results_add_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    ...
    test_add_me_pb000_DOMDEV["SNP1"] = test_add_me_pb000_DOMDEV["SNP1"].replace(2, 0)
    test_add_me_pb000_DOMDEV["SNP2"] = test_add_me_pb000_DOMDEV["SNP2"].replace(2, 0)
    ...
    DOMDEV_results_add_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    DOMDEV_results_add_me_pb000.insert(loc=0, column="TestSeed", value=test_seed)
    ...
    rec_results_add_me_pb000["odds ratio"] = np.exp(rec_results_add_me_pb000["Beta"])
    ...
    rec_results_add_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    ...
    dom_results_add_me_pb000["odds ratio"] = np.exp(dom_results_add_me_pb000["Beta"])
    ...
    dom_results_add_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    ...
    codom_results_add_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    codom_results_add_me_pb000.insert(loc=0, column="TestSeed", value=test_seed)
    ...
    edge_results_add_me_pb000["odds ratio"] = np.exp(edge_results_add_me_pb000["Beta"])
    ...
    edge_results_add_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    ...
    add_results_sup_add_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    add_results_sup_add_me_pb000.insert(loc=0, column="TestSeed", value=test_seed)
    ...
    DOMDEV_results_sup_add_me_pb000 = pd.concat(
        [DOMDEV_results_sup_add_me_pb000_SNP1, DOMDEV_results_sup_add_me_pb000_SNP2]
    )
    ...
    DOMDEV_results_sup_add_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    DOMDEV_results_sup_add_me_pb000.insert(loc=0, column="TestSeed", value=test_seed)
    ...
    rec_results_sup_add_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    rec_results_sup_add_me_pb000.insert(loc=0, column="TestSeed", value=test_seed)
    ...
    dom_results_sup_add_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    dom_results_sup_add_me_pb000.insert(loc=0, column="TestSeed", value=test_seed)
    ...
    codom_results_sup_add_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    codom_results_sup_add_me_pb000.insert(loc=0, column="TestSeed", value=test_seed)
    ...
    edge_results_sup_add_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    edge_results_sup_add_me_pb000.insert(loc=0, column="TestSeed", value=test_seed)
    ...
    add_results_dom_me_pb000["odds ratio"] = np.exp(add_results_dom_me_pb000["Beta"])
    ...
    add_results_dom_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    ...
    test_dom_me_pb000_DOMDEV["SNP1"] = test_dom_me_pb000_DOMDEV["SNP1"].replace(2, 0)
    test_dom_me_pb000_DOMDEV["SNP2"] = test_dom_me_pb000_DOMDEV["SNP2"].replace(2, 0)
    ...
    DOMDEV_results_dom_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    DOMDEV_results_dom_me_pb000.insert(loc=0, column="TestSeed", value=test_seed)
    ...
    rec_results_dom_me_pb000["odds ratio"] = np.exp(rec_results_dom_me_pb000["Beta"])
    ...
    rec_results_dom_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    ...
    dom_results_dom_me_pb000["odds ratio"] = np.exp(dom_results_dom_me_pb000["Beta"])
    ...
    dom_results_dom_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    ...
    codom_results_dom_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    codom_results_dom_me_pb000.insert(loc=0, column="TestSeed", value=test_seed)
    ...
    edge_results_dom_me_pb000["odds ratio"] = np.exp(edge_results_dom_me_pb000["Beta"])
    ...
    edge_results_dom_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    ...
    add_results_het_me_pb000["odds ratio"] = np.exp(add_results_het_me_pb000["Beta"])
    ...
    add_results_het_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    ...
    test_het_me_pb000_DOMDEV["SNP1"] = test_het_me_pb000_DOMDEV["SNP1"].replace(2, 0)
    test_het_me_pb000_DOMDEV["SNP2"] = test_het_me_pb000_DOMDEV["SNP2"].replace(2, 0)
    ...
    DOMDEV_results_het_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    DOMDEV_results_het_me_pb000.insert(loc=0, column="TestSeed", value=test_seed)
    ...
    rec_results_het_me_pb000["odds ratio"] = np.exp(rec_results_het_me_pb000["Beta"])
    ...
    rec_results_het_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    ...
    dom_results_het_me_pb000["odds ratio"] = np.exp(dom_results_het_me_pb000["Beta"])
    ...
    dom_results_het_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    ...
    codom_results_het_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    codom_results_het_me_pb000.insert(loc=0, column="TestSeed", value=test_seed)
    ...
    edge_results_het_me_pb000["odds ratio"] = np.exp(edge_results_het_me_pb000["Beta"])
    ...
    edge_results_het_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    ...
    add_results_null_me_pb000["odds ratio"] = np.exp(add_results_null_me_pb000["Beta"])
    ...
    add_results_null_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    ...
    test_null_me_pb000_DOMDEV["SNP1"] = test_null_me_pb000_DOMDEV["SNP1"].replace(2, 0)
    test_null_me_pb000_DOMDEV["SNP2"] = test_null_me_pb000_DOMDEV["SNP2"].replace(2, 0)
    ...
    DOMDEV_results_null_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    DOMDEV_results_null_me_pb000.insert(loc=0, column="TestSeed", value=test_seed)
    ...
    rec_results_null_me_pb000["odds ratio"] = np.exp(rec_results_null_me_pb000["Beta"])
    ...
    rec_results_null_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    ...
    dom_results_null_me_pb000["odds ratio"] = np.exp(dom_results_null_me_pb000["Beta"])
    ...
    dom_results_null_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    ...
    codom_results_null_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    codom_results_null_me_pb000.insert(loc=0, column="TestSeed", value=test_seed)
    ...
    edge_results_null_me_pb000.insert(loc=0, column="TrainSeed", value=train_seed)
    edge_results_null_me_pb000.insert(loc=0, column="TestSeed", value=test_seed)
