...
ext_modules = [
    Extension('pgenlib',
              sources=['pgenlib.pyx', '../pgenlib_ffi_support.cc', '../include/pgenlib_misc.cc', '../include/pgenlib_read.cc',
                       '../include/pgenlib_write.cc', '../include/plink2_base.cc', '../include/plink2_bits.cc'],
              language="c++",
              ...
              extra_compile_args=[
                  "-std=c++98", "-Wno-unused-function", "-Wno-macro-redefined"],
